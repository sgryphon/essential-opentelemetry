...
public class OpenTelemetryDebugEventListener(OpenTelemetryDebugOptions options) : EventListener
{
    ...
    protected override void OnEventWritten(EventWrittenEventArgs eventData)
    {
        ...
        try
        {
            ...
            var formattedMessage = string.Format(eventData.Message!, eventData.Payload!.ToArray())
                .ReplaceLineEndings("|");
            Console.WriteLine(
                "OTEL_DEBUG: {0} [{1}] {2}",
                eventData.Level,
