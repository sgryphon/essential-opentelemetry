...
public class OpenTelemetryDebugOptions
{
    public bool Debug { get; set; }
    public bool DebugOtlp { get; set; }
}

public class OpenTelemetryDebugService(IOptionsMonitor<OpenTelemetryDebugOptions> optionsProvider)
    : BackgroundService
{
    ...
    {
        listener = new DebugEventListener(optionsProvider.CurrentValue);
        return Task.CompletedTask;
    }

    private class DebugEventListener(OpenTelemetryDebugOptions options) : EventListener
    {
        protected override void OnEventSourceCreated(EventSource eventSource)
        {
            ...
            else if (options.Debug && eventSource.Name.StartsWith("OpenTelemetry-"))
            {
